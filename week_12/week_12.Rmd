...
# Notes on Torreira (2012) 
  ...
  * Results
    ...
    * Trade-offs (compensación, intercambio) between VOT and aspiration + closure duration
        ...
        * So... quite consistent negative relationship between VOT and preaspiration and closure duration -> This negative correlation meets the predictions of the coarticulatory account (of the occurrance of postaspiration in WAS voiceless stops)
